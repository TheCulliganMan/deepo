...
python generator/generate.py docker/Dockerfile.gdal_shapely-py36-cpu gdal_shapely python==3.6
python generator/generate.py docker/Dockerfile.pymssql-py36-cpu pymssql python==3.6
python generator/generate.py docker/Dockerfile.all-py36-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch darknet gdal_shapely pymssql python==3.6 onnx
python generator/generate.py docker/Dockerfile.all-jupyter-py36-cpu tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch darknet gdal_shapely pymssql python==3.6 onnx jupyter
...
python generator/generate.py docker/Dockerfile.gdal_shapely-py36-cu90 gdal_shapely python==3.6 --cuda-ver 9.0 --cudnn-ver 7
python generator/generate.py docker/Dockerfile.pymssql-py36-cu90 pymssql python==3.6 --cuda-ver 9.0 --cudnn-ver 7
python generator/generate.py docker/Dockerfile.all-py36-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch darknet gdal_shapely pymssql python==3.6 onnx --cuda-ver 9.0 --cudnn-ver 7
python generator/generate.py docker/Dockerfile.all-jupyter-py36-cu90 tensorflow sonnet mxnet cntk keras pytorch chainer theano lasagne caffe torch darknet gdal_shapely pymssql python==3.6 onnx jupyter --cuda-ver 9.0 --cudnn-ver 7
